...
- `ci/`, `.github/workflows/` — the pipeline. `all-e2e-tests.yml` runs the suite, `bootstrap-tests.yml` the scheduled start-up sweep over every ELK version, `targeted-e2e-tests.yml` one version on demand.
